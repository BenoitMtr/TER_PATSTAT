...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/js/CustomMap.js":[function(require,module,exports) {
...
var CustomMap = /*#__PURE__*/function (_ol$Map) {
  _inherits(CustomMap, _ol$Map);

  var _super = _createSuper(CustomMap);

  function CustomMap(elt) {
    var _this;
    ...
    _this = _super.call(this, {
      ...
      view: new View({
        center: fromLonLat([24.596220, 53.700813]),
        //center of europe
        zoom: 4.5
      })
    });
  ...
  _createClass(CustomMap, [{
    key: "removeVec",
    value: function removeVec(name) {
      this.removeLayer(this.vecCache[name]);
    }
  }, {
    key: "addVec",
    value: function addVec(name) {
    ...
    key: "highlight",
    value: function highlight(name, nb_bevret) {
      var vecName = this.formatCode.highlight(name);

      if (!this.vecCache[vecName + "LB"]) {
        var feat_high = feature_cache.LB.getFeatureById(name).getGeometry().getCoordinates();
        var geom_arr = new MultiLineString(feature_cache.LB.getFeatures().reduce(function (arr, feat, i) {
          if (feat.name === name) return arr;
          arr.push(new LineString([feat_high, feat.getGeometry().getCoordinates()]));
          return arr;
        }, []));
        var styles = geom_arr.getLineStrings().map(function (ls) {
          return new Style({
            stroke: new Stroke({
    ...
    key: "unhighlight",
    value: function unhighlight(name) {
    ...
    key: "showKML",
    value: function showKML(url, name) {
      var vecName = this.formatCode.KML(name); // If VectorLayer not in cache create new
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/js/CustomMap.js"], null)
//# sourceMappingURL=/CustomMap.8a0d4e6d.js.map